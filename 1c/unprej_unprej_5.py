...
print("Running model G1 unprejudiced + G2 unprejudiced in the ratio 500:500")
model_list = []
for r in range(10):
...
with open('1c/models/unprej_unprej/500-500.pkl', 'wb') as output:
    pickle.dump(model_list, output, pickle.HIGHEST_PROTOCOL)
print("Model saved as 1c/models/unprej_unprej/500-500.pkl")
print()
