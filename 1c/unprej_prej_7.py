...
print("Running model G1 unprejudiced + G2 prejudiced in the ratio 700:300")
model_list = []
for r in range(10):
...
with open('1c/models/unprej_prej/700-300.pkl', 'wb') as output:
    pickle.dump(model_list, output, pickle.HIGHEST_PROTOCOL)
print("Model saved as 1c/models/unprej_prej/700-300.pkl")
print()
