...
print ("Running Experiment with 5 Groups prejudiced")
...
import pickle
with open('4b/5_group.pkl', 'wb') as output:
    pickle.dump(model_list, output, pickle.HIGHEST_PROTOCOL)

print("Saved model 4b/1_group.pkl")
print()
