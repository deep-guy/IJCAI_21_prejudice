...
print("Running model G1 prejudiced + G2 Unprejudiced in the ratio 600:400")
model_list = []
for r in range(10):
...
with open('1c/models/prej_unprej/600-400.pkl', 'wb') as output:
    pickle.dump(model_list, output, pickle.HIGHEST_PROTOCOL)
print("Model saved as 1c/models/prej_unprej/600-400.pkl")
print()
